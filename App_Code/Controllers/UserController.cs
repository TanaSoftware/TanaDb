...

{
...

    {
        ...
        public HttpResponseMessage ConfirmRegister(string id)
        {
            UserManager userManager = new UserManager();
            bool isOk = userManager.ActivateUser(id);
            if(!isOk)
            ...
            string fullyQualifiedUrl = Request.RequestUri.GetLeftPart(UriPartial.Authority) + "/Start.html?ver=" + ConfigManager.version;
        ...
        public HttpResponseMessage ConfirmCustomeRegister(string id)
        {
            UserManager userManager = new UserManager();
            bool isOk = userManager.ActivateCustomer(id);
            var response = new HttpResponseMessage();
        ...
        public object UserAddCustmer(AddedCustomerByUser id)
        ...
        [ActionName("UpdateUserColor")]
        public string UpdateUserColor(UserActivities id)
        {

            UserManager userManager = new UserManager();

            return userManager.UpdateUserColor(id.Name, id.Id, id.color);
